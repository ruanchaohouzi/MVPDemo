...
public class LoginActivity2 extends BaseActivity<LoginPresenter> implements View.OnClickListener, ILoginView {
    ...
    public void initPresenter() {
        mPresenter = new LoginPresenter(LoginActivity2.this);
    }
